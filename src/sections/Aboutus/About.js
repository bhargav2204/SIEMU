  ...
  render() {
    return <div className="row">
      <div className="col-md-12 text-center">
        <h1>OUR BUSINESS</h1>
        <h2>Henna Powder Suppliers & Exporters in India</h2>
        <div className="line"></div>
        <p style={{padding:"5px 7px"}}>Mr. Suraj Mal Parihar started our business in 1980 as a Mehandi Powder Udyog at Sojat City, the only wholesale market of henna in India.</p>
        <p>The CEO of the company joined him with the foundation of Natural Mahendi Powder Udyog in 2012. He is highly qualified and expert in manufacturing best quality henna products. He has invented some new henna colors and herbal mixers with his expertise.</p>
